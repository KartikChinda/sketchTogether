...
const MenuCard = () => {
    ...
    return (
        <div className='absolute top-10 bg-[#23120B] w-[1/4] left-1/2 rounded-md px-2 py-1 duration-150 translate-x-[-50%] flex flex-row md:gap-10 gap-5 md:hover:px-5 md:hover:py-2 justify-between items-center shadow-xl shadow-[#21209C]'>
